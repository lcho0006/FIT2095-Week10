        ...
        this.dbService.getActors().subscribe((data) => {
            ...
            for (let i = 0; i < this.actorsDB.length; i++) {
                if (this.actorsDB[i].movies.length >= 2) {
                    this.subsetDB.push(this.actorsDB[i]);
                }
            }
        });
    }
...
module.exports = __webpack_require__(/*! C:\Users\17chowlr\Downloads\University\2019 Sem 2\FIT2095\week10\src\main.ts */"./src/main.ts");
